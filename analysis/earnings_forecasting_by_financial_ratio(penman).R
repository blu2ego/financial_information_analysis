...
raw_fi_ratio_2018 <- read_xlsx("~/projects/financial_information_analysis/data/financial_ratios/financial_ratio_2018.xlsx", col_names = T, na = "")
raw_fi_ratio_2017 <- read_xlsx("~/projects/financial_information_analysis/data/financial_ratios/financial_ratio_2017.xlsx", col_names = T, na = "")
raw_fi_ratio_2016 <- read_xlsx("~/projects/financial_information_analysis/data/financial_ratios/financial_ratio_2016.xlsx", col_names = T, na = "")
raw_fi_ratio_2015 <- read_xlsx("~/projects/financial_information_analysis/data/financial_ratios/financial_ratio_2015.xlsx", col_names = T, na = "")
raw_fi_ratio_2014 <- read_xlsx("~/projects/financial_information_analysis/data/financial_ratios/financial_ratio_2014.xlsx", col_names = T, na = "")
raw_fi_ratio_2013 <- read_xlsx("~/projects/financial_information_analysis/data/financial_ratios/financial_ratio_2013.xlsx", col_names = T, na = "")
raw_fi_ratio_2012 <- read_xlsx("~/projects/financial_information_analysis/data/financial_ratios/financial_ratio_2012.xlsx", col_names = T, na = "")
raw_fi_ratio_2011 <- read_xlsx("~/projects/financial_information_analysis/data/financial_ratios/financial_ratio_2011.xlsx", col_names = T, na = "")
raw_fi_ratio_2010 <- read_xlsx("~/projects/financial_information_analysis/data/financial_ratios/financial_ratio_2010.xlsx", col_names = T, na = "")
raw_fi_ratio_2009 <- read_xlsx("~/projects/financial_information_analysis/data/financial_ratios/financial_ratio_2009.xlsx", col_names = T, na = "")
