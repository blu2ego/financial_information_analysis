...
raw_fi_ratio_2019 <- read_xlsx("~/projects/financial-information-analysis/data/fs/fr/financial_ratio_2019.xlsx", col_names = T, na = "")
raw_fi_ratio_2018 <- read_xlsx("~/projects/financial-information-analysis/data/fs/fr/financial_ratio_2018.xlsx", col_names = T, na = "")
...
# 원래 열 이름을 별도로 저장해 둠
raw_col_names <- names(raw_fi_ratio_2019)
